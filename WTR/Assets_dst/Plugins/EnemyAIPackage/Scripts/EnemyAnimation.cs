...
public class EnemyAnimation : MonoBehaviour
{
    ...
    // Add a bool variable to control animation
    ...
    void Awake()
    {
        ...
        // Creating an instance of the AnimatorSetup class and calling its constructor
    ...
    void NavAnimSetup()
    {
        // Check if we should play animation or follow patrol script
        if (!isAnimating)
            return;
    ...
    // Add a public method to toggle animation on/off
    public void ToggleAnimation(bool shouldAnimate)
    {
        isAnimating = shouldAnimate;
        // Enable or disable the NavMeshAgent based on the animation state
        nav.enabled = isAnimating;
        // Enable or disable the Animator based on the animation state
