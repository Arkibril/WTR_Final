    ...
    public class CameraZoom
    {
        ...
        #region Custom Methods
            public void Init(Camera _cam, CameraInputData _data)
            {
                ...
                if(fieldOfViewSlider == null) fieldOfView = 60;
                else fieldOfView = fieldOfViewSlider.value;
            ...
            IEnumerator ChangeFOVRoutine()
            {
                ...
                float  _targetFOV = m_camInputData.IsZooming ? fieldOfView : fieldOfView - 20;
            ...
            IEnumerator ChangeRunFOVRoutine(bool _returning)
            {
                ...
                float _currentFOV = m_cam.fieldOfView;
                float  _targetFOV = _returning ? fieldOfView : fieldOfView + 10;
