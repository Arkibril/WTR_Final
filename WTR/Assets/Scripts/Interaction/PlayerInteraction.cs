...
public class PlayerInteraction : MonoBehaviour
{
    ...
    private RecordPlayer _goodVinyleRecordPlayer;
    ...
    private void Update()
    {
        ...
        if (Physics.Raycast(transform.position, transform.forward, out hit, interactionDistance))
        {
            if (viewObject != null)
            {
                ...
                if (viewObject.name == "GoodVinyleRecordPlayer") _interactionType.HandleInteraction(InteractionType.interactionType.Click);
