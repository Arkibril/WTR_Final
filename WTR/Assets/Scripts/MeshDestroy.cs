...
public class MeshDestroy : MonoBehaviour
{
    ...
    var subParts = new List<PartMesh>();
        ...
        for (var i = 0; i < parts.Count; i++)
        {
            ...
            parts[i].GameObject.transform.parent = transform; // Set the new parts as children of the original object.
        }

        // Disable the original object instead of destroying it.
